        ...
        SubShader
    {
        ...
        // Upgrade NOTE: excluded shader from OpenGL ES 2.0 because it uses non-square matrices
                ...
                void surf(Input IN, inout SurfaceOutputStandard o)
                {
                    ...
                    if (distance(_WorldSpaceCameraPos, worldpos) > 250)
                        tile = 0.1f;
                    if (distance(_WorldSpaceCameraPos, worldpos) > 550)
                        tile = 0.01f;
                    if (distance(_WorldSpaceCameraPos, worldpos) > 1550)
                        tile = 0.001f;
                    half4 m_normal = 0;
                    half3 colN = 0;
                    float m = 0;
                ...
                col = blend(col, col.a / 2, sand, controlmap.b / 2);
        col = blend(col, col.a / 2, Rock ,controlmap.b);
